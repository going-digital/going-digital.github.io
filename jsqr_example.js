...
(function () {
  ...
  code.errorCorrection = code.ERROR_CORRECTION.L;        // Set the error correction level (L = Low).
  ...
  input.data = 'HTTP://GITHUB.COM/GOING-DIGITAL/QRPLUS';                     // Specify the data which should be encoded.
  ...
  matrix.scale = 8;                                      // Specify the scaling for graphic output.
